                ...
                if (this.backtest) {
                    ...
                    this.currentPortfolio.positions.forEach(async p => {
                        if (p.quantityLots?.units) {
                            ...
                            await this.sell(this.getTakeProfitPrice(1, p.averagePositionPrice), this.instrumentId, lots, 'TP');
                        } else {
        ...
        async stopLossPosition() {
            ...
            if (this.backtest) {
                ...
                this.currentPortfolio.positions.forEach(async p => {
                    ...
                    // p.instrumentId => this.instrumentId
                    await this.sell(this.getStopLossPrice(1, p.averagePositionPrice), this.instrumentId, lots, 'SL');
                });
            }
        }
